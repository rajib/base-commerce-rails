# RailsAdmin config file. Generated on June 15, 2013 01:34
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Base Commerce Rails', 'Admin']
  ...
  # config.excluded_models = [Category, Product, ProductProperty, Role, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Category, Product, ProductProperty, Role, User]
  ...
  #     configure :product_properties, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :title, :string 
  ...
  #     configure :invited_by_type, :string         # Hidden   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
